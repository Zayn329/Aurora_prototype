...
export default function Hero({
  ...
  return (
    <div id="overview" className="relative w-full bg-gradient-to-b from-sky-100/80 via-blue-50/60 to-transparent pt-10 sm:pt-14 pb-8 overflow-hidden select-none">
      ...
      <div className="relative w-full h-[380px] sm:h-[460px] md:h-[520px] mt-4 sm:mt-6 overflow-hidden">
        <HeroGlobe />
        {/* Seamless blend mask at bottom matching polar background */}
        <div className="absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-blue-50/90 via-sky-50/50 to-transparent pointer-events-none" />
      </div>
