...
export default function Landing() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-100/70 via-blue-50/50 via-cyan-50/30 to-slate-100 text-slate-900 flex flex-col font-sans selection:bg-sky-900 selection:text-white relative overflow-hidden scroll-smooth">
